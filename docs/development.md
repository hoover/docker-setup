...
2. run  `docker-compose pull`  to get the latest version of all containers  
3. pull the latest version of docker-setup by running `git pull` in your docker-setup directory.  
	If you have followed default installation instructions, this will be `opt/hoover`  
4. Build the UI anew, by running:  
	```shell
